...
public class ScreenRecorder : MonoBehaviour
{
    ...
    private string uniqueFilename(int width, int height)
    {
        ...
        var filename = string.Format("{0}/screen_{1}x{2}_{3}.{4}", folder, width, height, counter,
    ...
    void Update()
    {
        ...
        if (captureScreenshot || captureVideo)
        {
            ...
            Camera
                camera = this
                    .GetComponent<Camera>(); // NOTE: added because there was no reference to camera in original script; must add this script to Camera
